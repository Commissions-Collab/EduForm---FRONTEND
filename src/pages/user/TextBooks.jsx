    ...
    <main className="p-4">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 mt-8">
        ...
        <div className="space-y-4 text-sm text-gray-600">
          <p>
            • You have borrowed <strong>{dashboardData.borrow_book}</strong>{" "}
            textbook(s) from the school library.
          </p>
          {dashboardData.book_due_this_week > 0 && (
            <p className="text-yellow-700 bg-yellow-50 p-3 rounded-lg">
              ⚠️ <strong>{dashboardData.book_due_this_week}</strong> book(s) are
              due this week. Please return them on time to avoid fines.
            </p>
          )}
          <p>
          ...
          <p>• Late returns may result in fines or replacement charges.</p>
          <p>
            • Contact the library staff if you have any questions about textbook
            returns.
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 mt-8">
        ...
        <p className="text-gray-600">
          Detailed textbook information and return schedules will be displayed
          here once the backend API is fully implemented.
        </p>
      </div>
    </main>
  );
