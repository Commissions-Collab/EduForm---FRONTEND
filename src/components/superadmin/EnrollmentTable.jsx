...
import { LuGraduationCap, LuTrash, LuPen, LuUser } from "react-icons/lu";
...
const EnrollmentTable = ({ searchTerm }) => {
  const { enrollments, updateEnrollment, deleteEnrollment } =
  ...
  const handleEdit = (enrollment) => {
    updateFormData("enrollment", enrollment);
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {!enrollments.isLoading && (
              <div className="text-sm text-gray-500">
                ...
                {filteredRecords.length === 1 ? "enrollment" : "enrollments"}{" "}
                found
                {searchTerm && (
                  <span className="ml-1">
                    for "
        ...
        <table className="w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {enrollments.isLoading ? (
              ...
              paginatedRecords.map((enrollment) => (
                <tr
                  key={enrollment.id}
