        ...
        return (
          ...
          >
            <div className="flex items-center mb-2">
              ...
              <div className={`${stat.iconColor} mr-3`}>
                {" "}
              ...
              {/* Adjusted font size and added font-medium */}
            </div>
            ...
            {stat.link ? (
              <a
                href={stat.link.href}
                className={`${stat.changeColor} text-xs sm:text-sm mt-1 block`}
              >
                {" "}
                {/* Adjusted font size, added mt-1 block */}
                {stat.link.text}
              </a>
            ) : (
              <div className={`${stat.changeColor} text-xs sm:text-sm mt-1`}>
                {" "}
                {/* Adjusted font size, added mt-1 */}
                {stat.change}
              </div>
            )}
          </div>
