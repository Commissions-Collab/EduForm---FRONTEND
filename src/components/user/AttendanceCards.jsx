...
import { LuTriangleAlert, LuCircleX, LuCalendar, LuClock } from "react-icons/lu";
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                ...
                <div className="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <p className="text-sm text-gray-500">
                        {attendanceData.late_arrivals.count > 0 ? 'Late arrivals detected' : 'No late arrivals'}
                    </p>
                </div>
            ...
            {attendanceData.quarterly_summary.length > 0 && (
                <div className="mt-8">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Quarterly Summary</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {attendanceData.quarterly_summary.map((quarter, index) => (
                            <div key={index} className="bg-white p-4 rounded-lg shadow-sm border border-gray-200">
                                <h4 className="text-sm font-medium text-gray-700 mb-2">{quarter.quarter}</h4>
                                <p className="text-2xl font-bold text-blue-600">{quarter.attendance_rate}%</p>
