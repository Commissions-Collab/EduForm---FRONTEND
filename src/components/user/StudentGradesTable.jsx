...
const StudentGradesTable = () => {
  const { gradesData, gradesLoading, gradesError } = useStoreUser();
    ...
    return (
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div className="text-sm text-blue-700">
          <p>
            Your grades will appear here once they are recorded by your
            teachers.
          </p>
        </div>
      </div>
                  ...
                  >
                    ...
                    <td className="py-3 sm:py-4 px-2">
                      <div className="flex items-center gap-1">
                        ...
                        <span
                          className={`font-medium text-sm lg:text-base ${getTrendColor(
                            grade.trend
                          )}`}
                        >
                          {grade.trend > 0
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 ml-2">
                      ...
                      <span
                        className={`font-medium ${getTrendColor(grade.trend)}`}
                      >
                        {grade.trend > 0
                          ? `+${grade.trend}%`
                          : grade.trend < 0
